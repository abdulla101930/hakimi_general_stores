...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <>
      <div
        className={`product-card ${isHygiene ? 'card-hygiene' : 'card-food'}`}
      ...
      >
        ...
        <div className="product-info-box">
          <div className="product-variant-select-wrap" onClick={(e) => e.stopPropagation()}>
            <select
        ...
        <div className="product-bottom-row" onClick={(e) => e.stopPropagation()}>
      ...
      <ProductPreviewModal
        product={activePreviewProduct || product}
        isOpen={isPreviewOpen}
        onClose={() => setIsPreviewOpen(false)}
        onSelectProduct={(p) => setActivePreviewProduct(p)}
      />
    </>
  );
}
